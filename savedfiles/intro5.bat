...
ffmpeg64\bin\ffmpeg -ss 3 -t 15 -i audio.mp3 -acodec copy -y crop_audio.mp3
...
ffmpeg64\bin\ffmpeg -i K:\introtolean\interviews\AA036501.MXF -y audio.mp3
ffmpeg64\bin\ffmpeg -ss 18 -t 19 -i audio.mp3 -acodec copy -y crop_audio.mp3
...
ffmpeg64\bin\ffmpeg -shortest -i crop_video.mp4 -i audio.mp3 -vcodec copy -acodec copy -y K:\introtolean\interviews\AA036501.MXF_000000018_crop.mp4
REM cd C:\Users\khubbell\Desktop\IRU.Video.Prep.Tool\ 
REM del audio.mp3 
REM del crop_audio.mp3 
REM del crop_video.mp4