...
ffmpeg64\bin\ffmpeg -ss 85 -t 15 -i audio.mp3 -acodec copy -y crop_audio.mp3
ffmpeg64\bin\ffmpeg -ss 85 -i K:\introtolean\interviews\AA036501.MXF -frames:v 463 -vcodec libx264 -b:v 2000k -filter:v "crop=1080:720:364:256 ,scale=720:480" -y crop_video.mp4
...
ffmpeg64\bin\ffmpeg -i K:\introtolean\interviews\AA036501.MXF -y audio.mp3
ffmpeg64\bin\ffmpeg -ss 548 -t 19 -i audio.mp3 -acodec copy -y crop_audio.mp3
ffmpeg64\bin\ffmpeg -ss 548 -i K:\introtolean\interviews\AA036501.MXF -frames:v 574 -vcodec libx264 -b:v 2000k -filter:v "crop=1620:1080:144:0 ,scale=720:480" -y crop_video.mp4
